...
class TypeGenreAdapter(
    private var genres: List<DataItemtype>,
    private val onGenreClick: (DataItemtype) -> Unit
) : RecyclerView.Adapter<TypeGenreAdapter.ViewHolder>() {

    private var selectedPosition = RecyclerView.NO_POSITION

    class ViewHolder(val binding: ActivityContentTabSearchBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ActivityContentTabSearchBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (position == selectedPosition) {
            ...
            holder.binding.contentTab.setTextColor(
