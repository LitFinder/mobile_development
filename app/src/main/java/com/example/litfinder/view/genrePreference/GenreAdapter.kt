...
class GenreAdapter(private var genres: List<GenreItem>) :
    ...
    inner class GenreViewHolder(private val binding: ItemButtonGenreBinding) :
            ...
            binding.btnGenre.setOnClickListener {
                ...
                if (selectedGenreIds.contains(genre.id ?: -1)) {
                    ...
                    if (selectedGenreIds.size < 3) {
                        ...
                        Toast.makeText(binding.root.context, "Genre Maksimal 3", Toast.LENGTH_SHORT)
                            .show()
        ...
        fun bind(genre: GenreItem) {
            ...
            if (selectedGenreIds.contains(genre.id ?: -1)) {
                ...
                binding.btnGenre.backgroundTintList = ColorStateList.valueOf(
